...
pierwiastek <- function(x, est=1, prec=0.001){
  ...
  #Data check
  stopifnot("Inserted values have to be numeric"=(is.numeric(x) & is.numeric(est) & is.numeric(prec)) )
  stopifnot("EST has to greater than 0"=(est>0) )
